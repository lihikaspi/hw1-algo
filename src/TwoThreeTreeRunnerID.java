public class TwoThreeTreeRunnerID implements TwoThreeTree<RunnerID>{
    private Node root;

    /**
     * constructor implements 2_3_Init
     */
    public TwoThreeTreeRunnerID(){
        NodeRunnerID<RunnerID> x = new NodeRunnerID<>(false);
        NodeRunnerID<RunnerID> l = new NodeRunnerID<>(true);
        NodeRunnerID<RunnerID> m = new NodeRunnerID<>(true);
